...
// source http://codeaid.net/php/parse-ini-file-into-a-multi-dimensional-array

/**
 * Allows for multi-dimensional ini files.
 *
 * The native parse_ini_file() function will convert an ini file into an object.
...
class Ini
{
	...
	public static function parse($filename, $process_sections = false, $section_name = null)
	{
		...
		return self::bindArrayToObject(self::$_result);
	}
